<!-- ModalFormAddGuru -->
<template>
    <div class="modal fade" id="modalGuru" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-primary">
            <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">Adding Guru</h1>
          ...
          <form @submit.prevent="submitFormGuru">
            ...
            <div v-else class="modal-body row g-3">
                ...
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="text" :class="{ 'form-control': true,'is-invalid': error.nama }"  id="nama" placeholder="Mewagati eskarno putri" v-model="formData.nama" name="nama">
              ...
              <div class="col-md-6">
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="number" :class="{ 'form-control': true,'is-invalid': error.nip }" id="nip" placeholder="197501011998031002" v-model="formData.nip" name="nip" >
              ...
              <div class="col-md-6">
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="number" :class="{ 'form-control': true,'is-invalid': error.nuptk }" id="nuptk" placeholder="1234567890123456" v-model="formData.nuptk" name="nuptk" >
              ...
              <div class="col-md-3">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" role="switch" id="statusGuru" v-model="formData.status">
              ...
              <div class="col-md-3">
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                      <select :class="{ 'form-select': true, 'is-invalid': error.religion }" v-model="formData.religion" id="religion_name" aria-label="Floating label" name="religion">
                          <option value="" selected>Choose...</option>
              ...
              <div class="col-md-3">
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="number" :class="{ 'form-control': true,'is-invalid': error.parent_phone_number }"  id="parent_phone_number" placeholder="082283778895" v-model="formData.parent_phone_number" name="parent_phone_number">
              ...
              <div class="col-md-6">
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="text" :class="{ 'form-control': true,'is-invalid': error.email }"  id="email" placeholder="tes@gmail.com" v-model="formData.email" name="email">
              ...
              <div v-if="formData.photo_profile" >
                <img :src="formData.photo_profile" alt="Uploaded Image" style="width:30%">
              </div>
              ...
              <div class="col-md-12 mb-0">
                <div class="input-group mb-3">
                  ...
                  <div class="form-floating">
                    <input type="text" :class="{ 'form-control': true,'is-invalid': error.facebook }" id="facebook" placeholder="https://www.facebook.com/example_page" name="facebook"  v-model="formData.facebook">
              ...
              <div class="col-md-12 mb-0 mt-0">
                <div class="input-group mb-3">
                  ...
                  <div class="form-floating">
                    <input type="text" :class="{ 'form-control': true,'is-invalid': error.instagram }" id="instagram" placeholder="https://www.instagram.com/example_account" name="instagram" v-model="formData.instagram">
              ...
              <div class="col-md-12 mb-0 mt-0">
                <div class="input-group mb-3">
                  ...
                  <div class="form-floating">
                    <input type="text" :class="{ 'form-control': true,'is-invalid': error.linkedin }" id="linkedin" placeholder="https://www.linkedin.com/in/example_profile" name="linkedin" v-model="formData.linkedin">
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-primary" style="float: right;" type="submit" :disabled="loadingSubmitGuru">
                <span v-if="!loadingSubmitGuru"><i class="bi bi-arrow-repeat"></i> Submit Guru</span>
                <span v-else>
                  <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                  <label> Submit Guru</label>
                </span>
              </button>
            </div>
        </form>
  ...
  export default {
    ...
    methods: {
      ...
      async sendStoreGuru() {
        try {
            const response = await axios.post(`${this.baseUrl}/api/store_guru`, this.formData, {
                headers: {
            ...
            this.Toasttt('Successfully', 'success', 'Data Guru Successfully Stored')
            this.$emit('guruAdd'); //sent signal to views
            this.errorMessages = [];
            return response
