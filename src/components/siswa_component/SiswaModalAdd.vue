<!-- ModalFormAddSiswa -->
<template>
    <div class="modal fade" id="modalSiswa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-primary">
            <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">Adding Siswa</h1>
          ...
          <div v-if="!hasLoadedSiswa">
                ...
                <div class="input-group has-validation">
                  <div class="form-floating is-invalid">
                    <form class="form-floating">
                        <input type="text" :class="{ 'form-control': true,'is-invalid': error.nama }"  id="nama" placeholder="Sumail Ahmad" v-model="formData.nama" name="nama">
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-primary" style="float: right;" type="submit" :disabled="loadingSubmitSiswa">
                <span v-if="!loadingSubmitSiswa"><i class="bi bi-arrow-repeat"></i> Submit Siswa</span>
                <span v-else>
  ...
  export default {
    ...
    methods: {
      ...
      async sendStoreSiswa() {
        try {
            const response = await axios.post(`${this.baseUrl}/api/store_siswa`, this.formData, {
                headers: {
            ...
            this.Toasttt('Successfully', 'success', 'Data Siswa Successfully Stored')
            this.$emit('siswaAdd'); //sent signal to views
            this.errorMessages = [];
            return response
